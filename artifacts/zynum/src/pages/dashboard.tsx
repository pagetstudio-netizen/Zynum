    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 space-y-4 shadow-sm">
        ...
        <div className="flex gap-3">
          ...
          <Button
            size="sm"
            className="bg-[#26A5E4] hover:bg-[#1a8fc7] text-white gap-2"
          ...
          <div className="pt-3 mt-3 border-t border-gray-100 space-y-1">
            ...
            <button
              onClick={() => publicSettings.support_telegram
                ? openTelegramSupport(publicSettings.support_telegram)
                : window.open("/contact", "_self")}
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-500 hover:text-[#26A5E4] hover:bg-[#26A5E4]/10 transition-all"
            >
