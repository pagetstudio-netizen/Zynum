...
export const getOrderHistoryQueryLimitMax = 100;



export const GetOrderHistoryQueryParams = zod.object({
  "page": zod.coerce.number().int().min(1).default(getOrderHistoryQueryPageDefault),
  "limit": zod.coerce.number().int().min(1).max(getOrderHistoryQueryLimitMax).default(getOrderHistoryQueryLimitDefault)
})
